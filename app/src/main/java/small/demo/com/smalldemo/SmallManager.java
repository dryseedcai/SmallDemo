...
import small.demo.com.smalldemo.app.SmallHostApp;

/**
 * Created by caiminming on 2017/12/7.
 */
public class SmallManager {
    ...
    private void onUpgraded(boolean success) {
        ...
        Toast.makeText(SmallHostApp.getAppContext(), "onUpgraded=" + success, Toast.LENGTH_SHORT).show();
    }
